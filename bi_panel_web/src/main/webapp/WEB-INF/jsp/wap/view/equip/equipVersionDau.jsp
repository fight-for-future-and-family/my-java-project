...
<script type="text/javascript" src="/wap/js/equip/equipVersionDau.js?v=${version}"></script>
<style type="text/css">
			   ...
			   <ul class="detail-nav">
			    ...
			    <div class="area-sub">
					<div id="layout-t" class="tab-product tab-sub-3 ui-style-gradient">
						<h2 class="tab-hd">
							...
							<span class="tab-hd-con current" view="versionDau"><a></a>版本活跃分布</span> 
							<span class="tab-hd-con" view="installRetention"><a></a>新增设备留存</span>
						</h2>
			    ...
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/equip/downloadData.ac" enctype="multipart/form-data">
				  ...
				  <input name="gameId" type="hidden" value="${gameId }" />
					...
					<div class="detail-info" style="margin-top:10px;min-height:40px;">
				    	<ul class="detail-ul">
				    		<li class="detail-li">
