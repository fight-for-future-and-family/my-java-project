...
<script type="text/javascript" src="/wap/js/gameTestReport.js?v=${version}"></script>
<style type="text/css">
	...
	<jsp:include page="/WEB-INF/jsp/wap/common/header.jsp" />
		<div class="data-container-main">
			<div class="detail" style="width:100%;">
			   <ul class="detail-nav" >
			    ...
			    <div class="area-sub">
					<div id="layout-t" class="tab-product tab-sub-3 ui-style-gradient">
						<h2 class="tab-hd">
							<span class="tab-hd-con current" view="testReport"><a></a>总体</span> 
							<!-- <span class="tab-hd-con" view="yhwd"><a></a>用户维度</span> --> 
							<span class="tab-hd-con" view="sbwdview"><a></a>设备维度</span> 
						</h2>
			    ...
			    <%--  <input name="snid" type="hidden" value="${game.snid }" />
			     ...
			     <input id="gameRate" type="hidden" value="${game.rate }" />
			      <input id="view" name="view" type="hidden" value="allview" />
		       ...
		       <div id="data4" class="detail-table"></div>
   ...
   <table class="view_table">
      ...
      <tbody>
        <tr>
          ...
          <td class="dnu"></td>
          <td class="install"></td>
          <td class="role_choice"></td>
          <td class="payment_amount"></td>
          <td class="payer"></td>
          <td class="pay_rate"></td>
          <td class="arpu"></td>
          <td class="arppu"></td>
          <td class="new_equip"></td>
          <td class="install2"></td>
          <td class="jihuo_xinzeng_rate"></td>
          <td class="install_role_rate"></td>
        </tr>
      </tbody>
   </table>
</div>
