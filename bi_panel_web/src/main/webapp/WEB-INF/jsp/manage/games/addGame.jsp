	...
	<div class="lp-container">
		...
		<div class="data-container">
			<div class="detail">
				...
				<li>></li>
		    	<li class="active green">添加游戏</li>
			    </ol>
			    <div class="person-data">
			      <form:form id="submitForm" name="submitForm" method="post" modelAttribute="gamesVO" action="/panel_manage/gameManager/addGame.ac" enctype="multipart/form-data">
					<p class="warn-btn">
					...
					<ul class="p-ul mt20">
						...
						<li>
						    <span>
								<label for="entity.parentId">隶属游戏系列</label>
						...
						<li>
							<span>
								...
								<form:select path="entity.etlStatus" required="required" style="min-width:200px;max-width:200px;">
								   <form:option value="1">是</form:option>
								   <form:option value="0">否</form:option>
								</form:select>
								<font color="red">*</font>
						   ...
						   <span>
								...
								<form:select id="timeZone" path="entity.timeZone" style="min-width:100px;max-width:200px;">
						...
						<li> 
						   ...
						   <span>
							   ...
							   <form:input path="entity.monthKpi" cssClass="b-radius5 p-input" />
						   </span>
						   <span>
								<label for="entity.yearKpi">年目标KPI</label>
								<form:input cssClass="b-radius5 p-input" path="entity.yearKpi" />
							</span>
						</li>
						<li>
						   <span>
						   ...
						   <span style="clear: right;height:120px;">							
								...
								<img alt="logo" id="logo_img" src="" style="height:100px;width:100px;float:left;border: 1px solid #ebebeb;">
							...
							<form:input type="hidden"  id="logo" path="entity.logo" value=""/>
						</li>
					</ul>
				    ...
				    <li>
				      ...
				      <c:forEach items="${groupsList}" var="group">
				        ...
				        <span style="float: left;width:20%;text-align: left;padding-left: 3%">
					        ...
					        <label for="p-sex">${group.groupName }</label>
				        </span>
				      </c:forEach>
				      </li>
				    </ul>
