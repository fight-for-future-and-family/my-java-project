...
<script type="text/javascript" src="/js/gameLevel/newPayLevel.js?v=${version}"></script>
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       ...
			       <li id="newPaymentLevel" class="active"><a></a>新付费</li>
			    ...
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/payerLevel/downloadData.ac" enctype="multipart/form-data">
					...
					<input id="view" name="view" type="hidden" value="newPaymentLevel" />
