...
<script type="text/javascript" src="/js/games/gameTestReport.js?v=${version}"></script>
<style type="text/css">
.noneInput{
    outline:medium;
    border:0;
			...
			<div class="detail">
		    	...
		    	<li id="timeZoneName" style="float:right;font-size:12px;"></li>
			     ...
			     <%--  <input name="snid" type="hidden" value="${game.snid }" />
			      ...
			      <input id="view" type="hidden" value="yhwdview" />
			    <ul class="detail-nav">
			    	<li  id="all"><a href="#"></a>总体</li>
			       <li id="yhwd" class="active"><a href="#"></a>用户维度</li>
			       <li id="sbwd"><a></a>设备维度</li>
			    </ul>
