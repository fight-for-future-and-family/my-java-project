...
<script type="text/javascript" src="/js/games/gameAllPay.js?v=${version}"></script>
</head>
<body>
	...
	<div class="lp-container">
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       <li id="allPay" class="de-first active"><a ></a>付费总览</li>
			       <li id="newPay"><a></a>新付费</li>
			       <li id="payBehavior"><a></a>付费行为</li>
			    </ul>
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/gamePay/downloadData.ac" enctype="multipart/form-data">
			     ...
			     <input id="gameRate" type="hidden" value="${game.rate }" />
			      ...
			      <input id="view" name="view" type="hidden" value="paymentAll" />
			    ...
			    <div id="pay_level_chart" class="clear-fix" style="width: 49%;float: left;overflow: hidden;position: relative;">
			       ...
			       <div id="pay_rate" class="zhibiao"></div>
			    
			       <div id="pay_arppu" class="zhibiao"></div>
			    
			       <div id="pay_arpu" class="zhibiao"></div>
