...
<script type="text/javascript" src="/js/games/gameDau.js?v=${version}"></script>
</head>
<body>
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       ...
			       <li id="dau" class="active"><a href="#"></a>活跃</li>
			    ...
			    <input name="gamesId" type="hidden" value="${game.id }" />
			     ...
			     <input id="timeZone" type="hidden" value="${game.timeZone }" />
			      <input id="view" name="view" type="hidden" value="dau" />
			    ...
			    <div id="dau_sc_chart" class="clear-fix" style="width: 49%;float: left;overflow: hidden;position: relative;">
			       <div class="dataShap">
			        ...
			        <div id="dau_sc" class="zhibiao_pie"></div>
			        <div id="dau_sc_data" class="zhibiao_pie" hidden="hidden"
			         style="border: 1px solid #ebebeb;border-radius: 10px;margin-top: 0px;padding:10px 0px;"> </div>
			    </div>
			    
			    <div id="dau_sb_chart" class="clear-fix" style="width: 50%;float: right;overflow: hidden;position: relative;">
			       <div class="dataShap">
			           <ul style="top:19px;right:80px;">
						 <li class="onChoose"><em class="columnar">图</em></li>
						 <li><em class="linear">表</em></li>
					   </ul>
			       </div>
			        <div id="dau_sb" class="zhibiao_pie"></div>
			        <div id="dau_sb_data" class="zhibiao_pie" hidden="hidden"
			         style="border: 1px solid #ebebeb;border-radius: 10px;margin-top: 0px;padding:10px 0px;"> </div>
			    </div>
			    ...
			    <div id="dau_count_chart" class="clear-fix" style="width: 100%;overflow: hidden;position: relative;">
			       <div class="dataShap">
			           <ul style="top:6px;right:180px;">
						 <li class="onChoose"><em class="columnar">图</em></li>
						 <li><em class="linear">表</em></li>
			        ...
			        <div id="dau_count" class="zhibiao_pie"></div>
			        <div id="dau_count_data" class="zhibiao_pie" hidden="hidden"
			         style="border: 1px solid #ebebeb;border-radius: 10px;margin-top: 0px;padding:10px 0px;"> </div>
			    </div>
