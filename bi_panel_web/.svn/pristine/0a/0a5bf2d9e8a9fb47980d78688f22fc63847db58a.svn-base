...
<%@include file="/WEB-INF/jsp/common/headConfig.jsp"%>
  ...
  <script type="text/javascript" src="/wap/js/hourReportSourceRetention.js?v=${version}"></script>
  <style type="text/css">
  .ajax_loading{
    background:#fff;
    height:60px;
						...
						<h2 class="tab-hd">
							...
							<c:if test="${isDisplayHourReport or isAdmin or isLeader}">
								<span class="tab-hd-con" view="hourReport"><a></a>实时日报</span>
								 ...
								 <span class="tab-hd-con current" view="hourReportSourceRetention"><a href="#"></a>分渠道留存</span>
							</c:if>
						</h2>
