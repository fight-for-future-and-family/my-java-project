...
<script type="text/javascript" src="/js/games/tool/gameMultiIndicatorsContrast.js?v=${version}"></script>
</head>
<%
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       ...
			       <li id="multi_indicators" class="active"><a></a>多指标对比</li>
			    ...
			    <div id="chart" class="data-container-chart">
