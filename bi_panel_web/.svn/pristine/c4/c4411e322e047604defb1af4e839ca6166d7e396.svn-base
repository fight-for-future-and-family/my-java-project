...
<script type="text/javascript" src="/manage/js/adTracking/addPlatforms.js?v=${version}"></script>
	...
	<div class="lp-container">
		...
		<div class="data-container">
			<div class="detail">
				...
				<li>></li>
		    	<li class="active green">添加平台</li>
		    	
			    </ol>
			    <div class="person-data">
			      <form:form id="submitForm" name="submitForm" method="post" modelAttribute="platformsVO" action="/panel_manage/adManage/addPlatforms.ac" enctype="multipart/form-data">
