...
<script type="text/javascript" src="/manage/js/user/user.js?v=${version }"></script>
<style type="text/css">
.p-ul{
 min-height:100px;
 height:150px;
	...
	<div class="lp-container">
		...
		<div class="data-container">
			<div class="detail">
				...
				<li>></li>
		    	<li class="active green">添加用户</li>
			    </ol>
			    <div class="person-data">
			      <form:form id="submitForm" name="submitForm" method="post" modelAttribute="usersVO" action="/panel_manage/user/addUser.ac" enctype="multipart/form-data">
					<p class="warn-btn">
					  <span class="pt10 ml30" style="display:inline-block;"><span>基本信息</span></span>
					...
					<ul class="p-ul mt20">
						<li>
							...
							<form:input path="entity.loginName" cssClass="b-radius5 p-input" required="required" /> <font color="red">*</font>
							</span>
							
						    <span>
							<label for="entity.realName">真实姓名</label>
							<form:input path="entity.realName" cssClass="b-radius5 p-input" required="required" /> <font color="red">*</font>
							</span>
							
							<span>
							<label for="entity.password">密码</label>系统随机分配
							</span>
						</li>
						<li>
						   <span>
							 <label for="entity.email">邮箱</label>
							 <form:input type="email" cssClass="b-radius5 p-input" path="entity.email" required="required" /> <font color="red">*</font>
						   </span>
							
						   <span>
						    <label for="entity.telepone">手机</label>
							<form:input cssClass="b-radius5 p-input" path="entity.telepone" required="required" /> <font color="red">*</font>
							</span>
							<!-- 
							<span>
