...
<script type="text/javascript" src="/js/gameLevel/installLevel.js?v=${version}"></script>
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       ...
			       <li id="installLevel" class="active"><a></a>日注册</li>
			    ...
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/payerLevel/downloadData.ac" enctype="multipart/form-data">
					...
					<input id="view" name="view" type="hidden" value="installLevel" />
					<input id="queryType" name="queryType" type="hidden" value="install" />
