...
<script type="text/javascript" src="/js/gameLevel/installPaymentLevel.js?v=${version}"></script>
	...
	<div class="lp-container">
		...
		<div class="data-container">
			<div class="detail">
			    ...
			    <ul class="detail-nav">
			       <li id="dauLevel"><a ></a>DAU</li>
			       <li id="installLevel"><a></a>日注册</li>
			       <li id="installPaymentLevel" class="active"><a></a>新注册付费</li>
			    ...
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/payerLevel/downloadData.ac" enctype="multipart/form-data">
					...
					<input id="view" name="view" type="hidden" value="installPaymentLevel" />
					<input id="queryType" name="queryType" type="hidden" value="install_payment" />
					<div class="detail-info">
				    	<ul class="detail-ul">
				    		<li class="detail-li">
				    			<span class="detail-left">
					    			注册日期：<input type="text" class="b-radius5 p-input" style="padding-left:10px;width:100px;"  value="${ec_beginTime }" id="ec_beginTime" name="ec_beginTime"/>
				    			</span>
				    ...
				    <div id="dau_level_chart" class="zhibiao"></div>
			   		 ...
			   		 <div id="data" class="detail-table">
			   		   <div id="caption">
			   		   	  <span id="t_amount" class="ui-selected" val="install_payment" >消费额</span>
						  <span id="t_users" val="install_payers" class="last">消费人次</span>
