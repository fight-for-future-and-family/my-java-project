		...
		<div class="data-container" style="min-height:700px">
			<div class="detail">
			    ...
			    <div class="person-data">
			      <form:form id="submitForm" name="submitForm" method="post" modelAttribute="etlengineManageVO" action="/panel_manage/EtlengineManage/AddEtlengineManage.ac" enctype="multipart/form-data">
					  ...
					  <li>
						...
						<li style="width:100%">
							...
							<span>
								...
								<input id="entity.description" name="entity.description" class="b-radius5 p-input" 
								required="required" type="text" value="${etlengineManageVO.entity.description }"/>
								<font color="red">*</font>
							</span>
						...
						<li>
					  	...
					  	<li>
					  		 ...
					  		 <span style="width:100%;">
							    ...
							    <textarea id="template" name="entity.template" cssClass="b-radius5 p-input" 
							    style="height:400px;width:910px;float: left"required="required" value="${entity.template }"></textarea>	
