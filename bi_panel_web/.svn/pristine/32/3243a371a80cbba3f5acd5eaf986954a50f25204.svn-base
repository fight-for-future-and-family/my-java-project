...
<script type="text/javascript" src="/wap/js/equip/equipDau.js?v=${version}"></script>
<style type="text/css">
			   ...
			   <ul class="detail-nav">
			    ...
			    <div class="area-sub">
					<div id="layout-t" class="tab-product tab-sub-3 ui-style-gradient">
						<h2 class="tab-hd">
							<span class="tab-hd-con current" view="equipDau"><a></a>设备活跃</span> 
			    ...
			    <form:form id="downLoadForm" method="post" modelAttribute="gamesVO" action="/panel_bi/equip/downloadData.ac" enctype="multipart/form-data">
				  ...
				  <input name="gameId" type="hidden" value="${gameId }" />
					...
					<div class="detail-info" style="margin-top:10px;min-height:70px;">
				    	<ul class="detail-ul">
				    		<li class="detail-li">
