...
public class IpResolve  {
	...
	private static String dsf = "/usr/lib/hive/udfs/dbipcity.csv.gz";
...
//	private static IpResolve ipr;
	...
	public IpResolve() {
		try {
			System.out.println("create a new instance"+new Date());
			
			conf.set("fs.defaultFS", "hdfs://hlnn01:9000/");
//			conf.set("fs.defaultFS", "hdfs://tomcat3-206:8020/");
...
//			GeoEntity temp = IpResolve.lookup(ip);
