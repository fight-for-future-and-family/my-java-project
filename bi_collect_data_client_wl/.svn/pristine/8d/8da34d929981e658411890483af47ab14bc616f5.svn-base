package com.hoolai.bi.collectdata.client.util;
...
public class JSONUtils {
	...
	static {
		ignoreUnknownPropertiesObjectMapper
				.configure(
						DeserializationConfig.Feature.FAIL_ON_UNKNOWN_PROPERTIES,
						false);
		ignoreUnknownPropertiesObjectMapper.configure(
		...
		SerializationConfig serializationConfig = ignoreUnknownPropertiesObjectMapper
	...
	public static <T> String toJSONwithOutNullProp(T object) {
		try {
			return ignoreUnknownPropertiesObjectMapper
	...
	public static <T> T fromJSON(String jsonString,
			TypeReference<T> typeReference, boolean isIgnoreUnknownProperties) {
		ObjectMapper mapper = getObjectMapper(isIgnoreUnknownProperties);
		T object = null;
		try {
	...
	public static List<?> fromJSONToList(String jsonString,
			Class<?> collectionClass, Class<?>... elementClasses) {
		try {
			ObjectMapper mapper = getObjectMapper();
			JavaType javaType = getCollectionType(collectionClass,
					elementClasses);
	...
	public static ObjectMapper getObjectMapper(boolean isIgnoreUnknownProperties) {
		return isIgnoreUnknownProperties ? ignoreUnknownPropertiesObjectMapper
				: om;
	}
