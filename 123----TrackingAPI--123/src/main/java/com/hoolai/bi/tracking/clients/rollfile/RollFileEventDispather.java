...
public class RollFileEventDispather {
	...
	private static final Logger LOGGER = Logger.getLogger(RollFileEventSerializer.class);
...
//			}
		...
		LOGGER.info("create new RollFileEventSerializer for headerId:"+headerId+" thisId:"+this.hashCode());
		
		rollFileEventSerializer=new RollFileEventSerializer(this.rollFileClientConfig,gameHeader);
