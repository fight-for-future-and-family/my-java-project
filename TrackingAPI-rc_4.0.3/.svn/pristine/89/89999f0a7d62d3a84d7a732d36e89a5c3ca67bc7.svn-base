package com.hoolai.bi.tracking;
...
public class GameHeader {
	...
	public GameHeader(String category,String event) {
		...
		this.init();
		this.headerId=this.category+"_"+this.snid+"_"+this.gameid+"_"+this.ds;
	}
	...
	private void initDefaultVersion(){
		...
		this.snid=Long.parseLong(tmpArr[1]);
		this.gameid=Long.parseLong(tmpArr[2]);
		this.ds=tmpArr[3];
	}
