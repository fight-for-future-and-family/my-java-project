 ...
 */
public class GameInfo extends TrackBase {
	...
	public boolean checkBaseParmIsNull() {
		if(StringUtils.isEmpty(userId) || StringUtils.isEmpty(gameinfo)){
			return true;
		}
		return false;
	}
	...
	public void processDate() {
		this.setGameinfoDate(DateUtils.verifyDate(gameinfoDate, ds));
	...
	public void setTime(String gameinfoTime) {
		this.gameinfoTime = gameinfoTime;
	}
