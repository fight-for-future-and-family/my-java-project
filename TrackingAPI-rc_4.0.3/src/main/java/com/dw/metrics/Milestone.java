 ...
 * 
 */
public class Milestone extends TrackBase {
	...
	public boolean checkBaseParmIsNull() {
		if(StringUtils.isEmpty(userId) || StringUtils.isEmpty(milestone)){
			return true;
		}
		return false;
	}
	...
	public void processDate() {
		this.milestoneDate = (DateUtils.verifyDate(milestoneDate, ds));
	...
	public void setDate(String milestoneDate) {
		this.milestoneDate = milestoneDate;
	}
	...
	public void setTime(String milestoneTime) {
		this.milestoneTime = milestoneTime;
	}
