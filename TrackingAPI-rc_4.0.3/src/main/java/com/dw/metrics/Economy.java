 ...
 *
 */
public class Economy extends TrackBase {
	...
	public boolean checkBaseParmIsNull() {
		if(StringUtils.isEmpty(userId) || StringUtils.isEmpty(amount)){
			return true;
		}
		return false;
	}
	...
	public void processDate() {
		this.setEconomyDate(DateUtils.verifyDate(economyDate, ds));
	...
	public void setTime(String economyTime) {
		this.economyTime = economyTime;
	}
