...
public class SourceDailyReportVO extends AbstractObjectVO<SourceDailyReport> {
	...
	public SourceDailyReportVO() {
		super();
		this.entity=new SourceDailyReport();
	}

	public SourceDailyReportVO(SourceDailyReport entity) {
		super(entity);
	}
