...
public class LevelDauReportVO extends AbstractObjectVO<LevelDauReport>{
	...
	public LevelDauReportVO() {
		super();
		this.entity=new LevelDauReport();
	}

	public LevelDauReportVO(LevelDauReport entity) {
		super(entity);
	}
