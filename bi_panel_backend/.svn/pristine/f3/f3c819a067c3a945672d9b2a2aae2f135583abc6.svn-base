...
public class LevelInstallPayerReportVO extends AbstractObjectVO<LevelInstallPayerReport>{
	...
	public LevelInstallPayerReportVO() {
		super();
		this.entity=new LevelInstallPayerReport();
	}

	public LevelInstallPayerReportVO(LevelInstallPayerReport entity) {
		super(entity);
	}
