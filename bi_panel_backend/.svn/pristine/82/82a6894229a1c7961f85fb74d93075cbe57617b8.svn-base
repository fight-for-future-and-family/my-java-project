...
public class HourClientDailyReportVO extends AbstractObjectVO<HourClientDailyReport> {
	...
	public HourClientDailyReportVO() {
		super();
		this.entity=new HourClientDailyReport();
	}

	public HourClientDailyReportVO(HourClientDailyReport entity) {
		super(entity);
	}
