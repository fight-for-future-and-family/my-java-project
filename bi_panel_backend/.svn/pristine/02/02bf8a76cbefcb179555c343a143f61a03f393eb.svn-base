...
public class EconomyNewReportVO extends AbstractObjectVO<EconomyNewReport> {
	...
	public EconomyNewReportVO() {
		super();
		this.entity=new EconomyNewReport();
	}

	public EconomyNewReportVO(EconomyNewReport entity) {
		super(entity);
	}
