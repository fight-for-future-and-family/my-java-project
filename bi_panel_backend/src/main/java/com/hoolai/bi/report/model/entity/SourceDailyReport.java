...
public class SourceDailyReport {
    private Long id;
    ...
    public SourceDailyReport(){}
    
    public SourceDailyReport(String snid, String gameid){
    	this();
    	this.snid = snid;
		this.gameid = gameid;
    }

    public SourceDailyReport(String snid, String gameid, String source) {
		this(snid,gameid);
		this.source = source;
	}
