...
public class EquipModelRetentionLtvVO extends AbstractObjectVO<EquipModelRetentionLtv> {
	...
	public EquipModelRetentionLtvVO() {
		super();
		this.entity=new EquipModelRetentionLtv();
	}

	public EquipModelRetentionLtvVO(EquipModelRetentionLtv entity) {
		super(entity);
	}
