...
public class LevelNewPaymentVO extends AbstractObjectVO<LevelNewPayment>{
	...
	public LevelNewPaymentVO() {
		super();
		this.entity=new LevelNewPayment();
	}

	public LevelNewPaymentVO(LevelNewPayment entity) {
		super(entity);
	}
