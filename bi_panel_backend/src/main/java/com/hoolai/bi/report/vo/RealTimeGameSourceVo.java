...
public class RealTimeGameSourceVo  extends AbstractObjectVO<RealTimeGameSource>{
	private String snid;
	...
	public RealTimeGameSourceVo() {
		super();
		this.entity=new RealTimeGameSource();
		initDate();
	}

	public RealTimeGameSourceVo(RealTimeGameSource entity) {
		super(entity);
	}
