 ...
 * @version 创建时间：2012年10月17日 下午6:46:06  
 */
...
//		System.out.println("ssss==="+caldTmp.getInstance().getTime());
	...
	/**
	 * 获得从开始日期到截止日期间所有有效日期的字符数组,参数格式为YYYY-mm-dd
	 * 
	 * @param beginDate
	 *            格式为YYYY-mm-dd
	 * @param endDate
	...
	public static final String convertDateToYYYYMMddHHmmSS(Date paramDate)
	  {
	...
	public static final String getDateTime(String paramString, Date paramDate)
	  {
	    ...
	    String str = "";
	    if ((paramDate != null) && (paramString != null) && (!paramString.equals("")))
	    {
	...
	/**
	 * 将YYYYMMDD的串转换为YYYY_MM_DD
	 */
	public static String getYYYY_MM_DD(String strYYYYMMDD) {
		SimpleDateFormat sdf = new SimpleDateFormat(YYYY_MM_DD);
		SimpleDateFormat sdf1 = new SimpleDateFormat(YYYYMMDD);
		if(strYYYYMMDD!=null){
			Date d = null;
			try {
				d = sdf1.parse(strYYYYMMDD);
	...
	/**
	 * 将 YYYY_MM_DD的串转换为YYYYMMDD
	 */
	public static String getYYYYMMDD(String strYYYY_MM_DD) {
		SimpleDateFormat sdf = new SimpleDateFormat(YYYY_MM_DD);
		SimpleDateFormat sdf1 = new SimpleDateFormat(YYYYMMDD);
		if(strYYYY_MM_DD!=null){
			Date d = null;
			try {
				d = sdf.parse(strYYYY_MM_DD);
			} catch (ParseException e) {
				e.printStackTrace();
			}
	 ...
	 * @return
	 */
	public static Date string2DateBill(String s) {
		if (StringUtils.isEmpty(s)) {
			return null;
		}
		Date result = null;
    ...
    public static Date convertXMLGregorianCalendarToDate(String XMLGregorianCalendarStr){
    	
    	if(null != XMLGregorianCalendarStr && !"".equals(XMLGregorianCalendarStr)){
    		try {
				XMLGregorianCalendar xgcal = DatatypeFactory.newInstance().newXMLGregorianCalendar(XMLGregorianCalendarStr);
    ...
    public static String convertDateToXMLGregorianCalendar(Date date) {
    	String result = "";
		GregorianCalendar cal = new GregorianCalendar();
		try {
			XMLGregorianCalendar gc = null;
	...
	public static Date getDayBegin(Date date){
		...
		Date dDate = string2Date(dateStr + "000000", YYYYMMDDHHMMSS);
	...
	public static Date getDayEnd(Date date){
		...
		Date dDate = string2Date(dateStr + "235959", YYYYMMDDHHMMSS);
	...
	public static void main(String[] args){
		for(String s : getDayList("2015-01-01", "2015-01-01")){
