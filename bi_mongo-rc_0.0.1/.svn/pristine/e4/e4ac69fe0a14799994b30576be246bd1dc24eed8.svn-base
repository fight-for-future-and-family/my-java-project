...
import com.hoolai.bi.mongo.access.AbstractDao;
import com.hoolai.bi.mongo.annotations.Default;
import com.hoolai.bi.mongo.annotations.Embed;
import com.hoolai.bi.mongo.annotations.EmbedList;
import com.hoolai.bi.mongo.annotations.EnsureIndex;
import com.hoolai.bi.mongo.annotations.Entity;
import com.hoolai.bi.mongo.annotations.Id;
import com.hoolai.bi.mongo.annotations.IdType;
import com.hoolai.bi.mongo.annotations.Property;
import com.hoolai.bi.mongo.annotations.Ref;
import com.hoolai.bi.mongo.annotations.RefList;
import com.hoolai.bi.mongo.annotations.SplitType;
import com.hoolai.bi.mongo.bitwise.BitwiseQuery;
import com.hoolai.bi.mongo.cache.FieldsCache;
import com.hoolai.bi.mongo.exception.IdException;
import com.hoolai.bi.mongo.geo.GeoQuery;
import com.hoolai.bi.mongo.join.JoinQuery;
import com.hoolai.bi.mongo.listener.CascadeDeleteListener;
import com.hoolai.bi.mongo.listener.EntityListener;
import com.hoolai.bi.mongo.parallel.ParallelTask;
import com.hoolai.bi.mongo.parallel.Parallelable;
import com.hoolai.bi.mongo.utils.IdUtil;
import com.hoolai.bi.mongo.utils.MapperUtil;
import com.hoolai.bi.mongo.utils.Operator;
import com.hoolai.bi.mongo.utils.ReferenceUtil;
import com.hoolai.bi.mongo.utils.SortUtil;
import com.hoolai.bi.mongo.utils.StringUtil;
import com.hoolai.bi.mongo.utils.ThreadUtil;
...
public class BuguDao<T> extends AbstractDao {
    ...
    /**
     * 初始化链接名称
     * @date 2017年8月15日 上午10:37:39
     * @author 邹友
     * @param args
     */
    public void initConnectionName(String ...args) {
